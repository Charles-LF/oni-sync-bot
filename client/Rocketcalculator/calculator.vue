            ...
            <div class="content-layout">
                ...
                <k-card class="form-card sci-fi-card">
                    ...
                    <div class="config-section">
                        ...
                        <el-form :model="form" size="large" class="sci-fi-form" label-position="top">
                    ...
                    <div class="config-section">
                        ...
                        <el-form :model="form" size="large" class="modules-form" label-position="top">
                ...
                <k-card class="result-card sci-fi-card">
                    ...
                    <template v-if="!result">
                        <div class="empty-state">
                            ...
                            <p class="empty-hint">请配置核心参数与载荷</p>
                        </div>
                    </template>
...
const handleCalculate = () => {
    try {
        ...
        result.value = res;
        if (res.length > 0) {
            message.success("解算完成！已收敛到最优解");
        } else {
            message.warning("解算失败，无解空间");
        }
    } catch (e) {
        message.error("解算器异常");
        console.error(e);
